...
default['tomcat_test']['instances'] = [1]

default['tomcat_test']['webapps_dir'] = "/opt/apps/tomcat/A/tomcatA-1/apache-tomcat-7.0.27/webapps"

default['tomcat_test']['webapps']['dir'] = "/opt/apps/tomcat/B/tomcatB-1/apache-tomcat-7.0.27/webapps"